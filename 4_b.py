input_str_ex="""ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
...
iyr:2011 ecl:brn hgt:IndentationError
"""

input_str="""iyr:2015 cid:189 ecl:oth byr:1947 hcl:#6c4ab1 eyr:2026
hgt:174cm
pid:526744288
...
def passportIsValid(passport):
    ...
    if len(reqFields - passport.keys()) > 0 \
        or len(passport["byr"]) != 4 \
        or len(passport["iyr"]) != 4 \
        or len(passport["eyr"]) != 4 \
        or False:
        return False
